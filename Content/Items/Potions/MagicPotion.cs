...
namespace OSRSPotions.Content.Items.Potions
{
    ...
    public class MagicPotion : OSRSBuffPotion
    {
        ...
        public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs(MagicPotionBuff.MagicPotionBonus * 100);

        public override void SetDefaults()
        {
            base.SetDefaults();

            Item.buffType = ModContent.BuffType<MagicPotionBuff>();
        ...
        {
            return [ModContent.BuffType<AncientBrewBuff>()];
        }
